...
npzdata=np.load(result_folder+"/models/"+"epoch_{}_weights_attack_shallow_model_{}.npz".
                format(user_epochs,args.adv), allow_pickle=True)
weights=npzdata['x']

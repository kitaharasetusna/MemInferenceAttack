...
'''==================================================='''
def create_nn_location_model(input_shape, num_classes):
    inputs = Input(shape=input_shape)
    middle_layer = Dense(1024, kernel_initializer=keras.initializers.glorot_uniform(seed=100), activation='relu')(
        inputs)
    middle_layer = Dense(512, kernel_initializer=keras.initializers.glorot_uniform(seed=100), activation='relu')(
        middle_layer)
    middle_layer = Dense(256, kernel_initializer=keras.initializers.glorot_uniform(seed=100), activation='relu')(
        middle_layer)
    middle_layer = Dense(128, kernel_initializer=keras.initializers.glorot_uniform(seed=100), activation='relu')(
        middle_layer)
    outputs_logits = Dense(num_classes, kernel_initializer=keras.initializers.glorot_uniform(seed=100))(middle_layer)
